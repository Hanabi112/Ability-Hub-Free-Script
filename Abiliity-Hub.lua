if game.CoreGui:FindFirstChild('BlueXLoader') then
    game.CoreGui:FindFirstChild('BlueXLoader'):Destroy()
end
...
function createTween(Object,setup,settings)
	...
	wait(2)
        ...
        if game.PlaceId == 2753915549 then
            Message.Text = "Blox Fruits [First Sea]"
	...
	loadstring(game:HttpGet"https://raw.githubusercontent.com/Hanabi112/King_Lagacy/main/Abiliity-Hub.lua")()
      else
